    ...
    function displayView($view, $id = 0)
    {
        ...
        switch ($view)
        {
            ...
            case 'view':
                ...
                $entry = Api::call($id, array(
                    'user_id' => $this->user->getId(),
                    'key' => $this->user->getConfigValue('api')
                ));
            ...
            default: # home, favorites and archive views 
                ...
                if (count($entries) > 0) {
                    ...
                    $datas = Api::call('', array(
                        'user_id' => $this->user->getId(),
                        'key' => $this->user->getConfigValue('api'),
                        'view' => $view,
                        'limit' => $this->user->getConfigValue('pager'),
                        'start' => $this->pagination->get_start(),
                    ));
